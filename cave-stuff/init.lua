...
minetest.register_node("cave-stuff:pebble_1",{
	drawtype = "nodebox",
	description = "Pebble",
...
--			{ left, bottom, front,  right, top ,  back}
    ...
    on_place = function(itemstack, placer, pointed_thing)
		...
		local stack = ItemStack("cave-stuff:pebble_"..math.random(1,2))
		local ret = minetest.item_place(stack, placer, pointed_thing)
		return ItemStack("cave-stuff:pebble_1 "..itemstack:get_count()-(1-ret:get_count()))
	end,
    sounds = default.node_sound_stone_defaults(),
})

minetest.register_node("cave-stuff:pebble_2",{
	drawtype = "nodebox",
	drop = "cave-stuff:pebble_1",
    tiles = {"undergrowth_pebble.png"},
    paramtype = "light",
	paramtype2 = "facedir",
...
minetest.register_node("cave-stuff:desert_pebble_1",{
	drawtype = "nodebox",
...
--			{ left, bottom, front,  right, top ,  back}
    ...
    on_place = function(itemstack, placer, pointed_thing)
		-- place a random pebble node
		local stack = ItemStack("cave-stuff:desert_pebble_"..math.random(1,2))
		local ret = minetest.item_place(stack, placer, pointed_thing)
		return ItemStack("cave-stuff:desert_pebble_1 "..itemstack:get_count()-(1-ret:get_count()))
	end,
    sounds = default.node_sound_stone_defaults(),
})

minetest.register_node("cave-stuff:desert_pebble_2",{
	drawtype = "nodebox",
	drop = "cave-stuff:desert_pebble_1",
    tiles = {"default_desert_stone.png"},
    paramtype = "light",
	paramtype2 = "facedir",
...
minetest.register_node("cave-stuff:stalactite_1",{
	drawtype="nodebox",
	tiles = {"undergrowth_pebble.png"},
...
minetest.register_node("cave-stuff:stalactite_2",{
	drawtype="nodebox",
	tiles = {"undergrowth_pebble.png"},
	groups = {cracky=3,attached_node=1,not_in_creative_inventory=1},
	drop = "cave-stuff:stalactite_1",
	paramtype = "light",
	paramtype2 = "wallmounted",
	node_box = {
		type = "fixed",
...
minetest.register_node("cave-stuff:stalactite_3",{
	drawtype="nodebox",
	tiles = {"undergrowth_pebble.png"},
	groups = {cracky=3,attached_node=1,not_in_creative_inventory=1},
	drop = "cave-stuff:stalactite_1",
				...
				if ground_y then
					...
					if minetest.registered_nodes[nn] and
						...
						if nn == "default:dirt_with_grass" then
							minetest.set_node(p,{name="cave-stuff:pebble_"..pr:next(1,2)})
						elseif nn == "default:desert_sand" then
							minetest.set_node(p,{name="cave-stuff:desert_pebble"..pr:next(1,2)})
					    end
					end
				end
